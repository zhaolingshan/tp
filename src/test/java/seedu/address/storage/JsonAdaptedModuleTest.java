...
public class JsonAdaptedModuleTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedModule person =
                new JsonAdaptedModule(INVALID_NAME, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedModule person = new JsonAdaptedModule(null, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedModule person =
                new JsonAdaptedModule(VALID_NAME, INVALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedModule person =
                new JsonAdaptedModule(VALID_NAME, VALID_ADDRESS, invalidTags);
