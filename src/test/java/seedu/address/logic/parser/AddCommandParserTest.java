...
import static seedu.address.testutil.TypicalModules.MOD_C;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Module expectedModule = new ModuleBuilder(MOD_C).withTags(VALID_TAG_FRIEND)
                .withSemester(VALID_SEMESTER.toString()).build();

        // whitespace only preamble
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + MOD_NAME_DESC_B
                + GRADE_DESC_B + TAG_DESC_FRIEND, new AddCommand(expectedModule));
