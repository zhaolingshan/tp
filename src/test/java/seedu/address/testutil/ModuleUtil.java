...
public class ModuleUtil {
    ...
    public static String getModuleDetails(Module module) {
        ...
        sb.append(PREFIX_GRADE + module.getGrade().getCap().getGradeString() + " ");
    ...
    public static String getEditModuleDescriptorDetails(EditCommand.EditModNameDescriptor descriptor) {
        ...
        descriptor.getGrade().ifPresent(grade -> sb.append(PREFIX_GRADE).append(grade.getCap().getGradeString()).append(" "));
